...
using UnityEngine.VspAttribution.echo3D;
...
public class echo3D : MonoBehaviour
{
    ...
    private string src = "UnityAssetStoreSDK";
    ...
    // Unity VSP Attribution Parameters
    private static readonly string ActionName = "UseSDK";
    private static readonly string PartnerIdentifier = "echo3D";
    ...
    void Start()
    {
        ...
        try
        {
            ...
            // Send Unity VPS Attribution anayltics
            VspAttribution.SendAttributionEvent(ActionName, PartnerIdentifier, APIKey);
        }
